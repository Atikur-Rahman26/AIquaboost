...
class _UpdateProfileState extends State<UpdateProfile> {
  ...
  void initState() {
    ...
    storedInputsList['phone_number'] = Profile.userInfoData!.phone_number;
    roleValue = storedInputsList['role'] = Profile.userInfoData!.role;
    ...
    userPersonalInfoController.forEach((key, controller) {
      controller.text = storedInputsList[key]!;
    });
    super.initState();
  }
  ...
  Widget DropDownWithIcon({
    ...
    return Padding(
      ...
      child: DropdownButtonFormField<String>(
        value: storedInputsList[fieldName], // Set the preloaded value
        ...
        onChanged: (value) {
          setState(() {
            storedInputsList[fieldName] = value!;
          });
        },
  ...
  Widget inputWithIcon({
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration:
            InputDecoration(prefixIcon: Icon(iconData), hintText: hintText),
        onChanged: (value) {
          if (AddressOrExpOrAcademic == 'person') {
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      if (Done) {
                        ...
                        bool update = await setUsersInfo();
                        if (update) {
                          clearTextEditingController(
                              personal: 1,
                              address: 1,
